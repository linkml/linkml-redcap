...
linkml_meta = LinkMLMeta({'default_prefix': 'redcap_data_dictionary',
     'default_range': 'string',
     'description': 'A LinkML representation of REDCap data dictionaries, '
                    'instruments, and database structure',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'redcap_data_dictionary': {'prefix_prefix': 'redcap_data_dictionary',
                                             'prefix_reference': 'https://w3id.org/aslgraefe/redcap-data-dictionary/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://aslgraefe.github.io/redcap-data-dictionary'],
     'source_file': 'src/redcap_data_dictionary/schema/redcap_data_dictionary.yaml',
     'title': 'redcap-data-dictionary'} )
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/aslgraefe/redcap-data-dictionary'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/aslgraefe/redcap-data-dictionary',
